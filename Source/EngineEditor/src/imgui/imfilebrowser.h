...
namespace ImGui
{
    ...
    public:
        ...
        inline void SetFlagOptions(ImGuiFileBrowserFlags flags)
        {
            flags_ = flags;
        }

        inline void InitializeNewDirectoryNameBuffer()
        {
...
inline void ImGui::FileBrowser::Display()
{
    ...
    if(flags_ & ImGuiFileBrowserFlags_CreateNewDir)
    {
        ...
        if(SmallButton("+"))
        {
            ...
            InitializeNewDirectoryNameBuffer();
        }
        else
        {
