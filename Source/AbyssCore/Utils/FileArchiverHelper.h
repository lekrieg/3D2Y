...
namespace abyss
{
	namespace utils
	{
		...
		public:
			ArchiveHeader() : m_id({'\0'}), m_majorVersion(0), m_minorVersion(0), m_totalFiles(0) {}
			...
			int SetMajorVersion(int major) { m_majorVersion = major; }
			int SetMinorVersion(int minor) { m_minorVersion = minor; }
			int SetTotalFiles(int total) { m_totalFiles = total; }
