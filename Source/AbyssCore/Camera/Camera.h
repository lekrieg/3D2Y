...
namespace abyss
{
	namespace camera
	{
		...
		public:
			...
			Camera(math::Vector3D& pos, math::Vector3D& lookAt, math::Vector3D& up, math::Vector3D& right);
			...
			math::Vector3D GetPosition() const { return m_pos; }
			math::Vector3D GetLookDirection() const { return m_lookAt; }
			math::Vector3D GetUpDirection() const { return m_up; }
			math::Vector3D GetRightDirection() const { return m_right; }
		};
	}
}
